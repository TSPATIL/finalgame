...
const { addFeedback, getAllFeedback, getFeedbackByUserId, getFeedbackByFeedbackId, deleteFeedback, getFeedbackByResultId } = require('../controllers/Feedback');
...
router.route('/get-feedback-by-resultId/:resultId').get(verifyUser, getFeedbackByResultId);
