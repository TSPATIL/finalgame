        ...
        <div class="absolute top-0 left-0 sm:relative z-20 w-[90vw] sm:w-[300px] h-full bg-gray-900 rounded p-3 shadow-xl">
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li className="space-y-2 group">
              <Link to="/admin/admin-login" class="flex items-center space-x-3  text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 bg-gray-200 focus:shadow-outline">
            ...
            {/* <div className="login-side w-[45%] h-screen flex justify-center items-center"> */}
              <div className="flex justify-center items-center flex-col h-full">
                ...
                <div className="mt-5">
                  <p>
                    Not Registered Yet?{" "}
                    <Link to="/signup" className="text-[#f134a6]">
                      Create an Account
                    </Link>
                  </p>
                </div>
