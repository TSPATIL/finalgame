...
export default function Profile() {
    const [details, setDetails] = useState({ fname: '', mname: '', lname: '', email: '', phone: '', date: '', gender: 'Male', image: null, bio: '', street: '', city: '', country: '', state: '', pincode: '', skills: [], links: [{ name: '', address: '' }], education: [{ degree: '', institute: '', startDate: '', endDate: '', status: 'pursuing' }] });
    ...
    const handleEducationOnChange = (e, index) => {
        ...
        updateEducationDetails[index][e.target.name] = e.target.value;
        setDetails({ ...details, education: updateEducationDetails });
    }
    ...
    return (
        <div className='Profile bg-gray-900 text-white flex justify-center items-center py-10'>
            <button className='absolute top-20 text-white px-3 py-2 md:px-5 md:py-3 bg-blue-700 text-lg rounded-md left-[11%]'>Go Back</button>
            ...
            <form className='w-4/5' onSubmit={handleSubmit}>
                <div className='flex justify-center items-center'>
                    <img src={details.image === null ? '' : URL.createObjectURL(details.image)} alt="" className='w-36 h-36 rounded-full flex justify-center items-center border-4 border-yellow-500' />
                ...
                <div className='w-full mt-5'>
                    ...
                    <div className="md:flex mt-4 md:gap-5 justify-center items-center">
                        <div className="w-full md:w-1/3 flex flex-col md:mt-0 mt-3">
                            ...
                            <input type="text" id='fname' name='fname' placeholder='First name' value={details.fname} onChange={handleOnChange} className="leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-3 border-0 bg-gray-800 rounded" />
                        </div>
                        <div className="w-full md:w-1/3 flex flex-col md:mt-0 mt-3">
                            <label className="font-semibold leading-none text-gray-300" htmlFor='mname'>Middle Name</label>
                            <input type="text" id='mname' name='mname' placeholder='Middle name' value={details.mname} onChange={handleOnChange} className="leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-3 border-0 bg-gray-800 rounded" />
                        </div>
                        <div className="w-full md:w-1/3 flex flex-col md:mt-0 mt-3">
                            <label className="font-semibold leading-none text-gray-300" htmlFor='lname'>Last Name</label>
                            <input type="text" id='lname' name='lname' placeholder='Last name' value={details.lname} onChange={handleOnChange} className="leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-3 border-0 bg-gray-800 rounded" />
                        </div>
                    </div>
                    <div className='md:flex mt-3 md:mt-5 md:gap-5 justify-center items-center'>
                        <div className="w-full md:w-1/2 flex flex-col md:mt-0 mt-3">
                            <label className="font-semibold leading-none text-gray-300" htmlFor='fname'>Email</label>
                            <input type="email" id='email' name='email' placeholder='Email' disabled value={details.email} onChange={handleOnChange} className="leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-3 border-0 bg-gray-800 rounded" />
                        </div>
                        <div className="w-full md:w-1/2 flex flex-col md:mt-0 mt-3">
                            <label className="font-semibold leading-none text-gray-300" htmlFor='mname'>Phone</label>
                            <input type="tel" id='phone' name='phone' placeholder='Phone no.' value={details.phone} onChange={handleOnChange} className="leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-3 border-0 bg-gray-800 rounded" />
                        </div>
                    </div>
                    <div className='md:flex mt-3 md:mt-5 md:gap-5 justify-center items-center'>
                        <div className="w-full md:w-1/3 flex flex-col md:mt-0 mt-3">
                            <label className="font-semibold leading-none text-gray-300" htmlFor='date'>Date of Birth</label>
                            <input type="date" id='date' name='date' value={details.date} onChange={handleOnChange} className="leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-3 border-0 bg-gray-800 rounded" />
                        </div>
                        <div className="w-full md:w-1/3 flex flex-col md:mt-0 mt-3">
                            <label className="font-semibold leading-none text-gray-300" htmlFor='gender'>Gender</label>
                            <select value={details.gender} name='gender' id='gender' onChange={handleOnChange} className='leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-3 border-0 bg-gray-800 rounded'>
                                ...
                                <div className='flex justify-start items-center flex-wrap w-full'>
                                    {
                                        details.skills.length === 0
                                            ...
                                            details.skills.map((skill, i) => {
                                                return (
                                                    <div>
                                                        <div key={skill + " " + i} className='bg-blue-700 text-white px-3 py-2 mr-2 my-2 md:m-2 text-sm font-bold'>{skill}</div>
                                                        {/* <GoDash className='relative -top-[3.5rem] h-fit rounded-full p-[1px] bg-red-600 text-black font-bold text-lg w-fit'/> */}
                                                    </div>
                                                )
                                            })
                                    }
                                ...
                                details.education.map((ed, i) => {
                                    return (
                                        <div key={ed + " " + i} className='mb-3'>
                                            ...
                                            <div className='md:flex justify-center items-center gap-3'>
                                                <input type="date" name="startDate" id="startDate" placeholder='Start Date' value={ed.startDate} onChange={(e) => handleEducationOnChange(e, i)} className='w-full leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-3 border-0 bg-gray-800 rounded' />
                                                <input type="date" name="endDate" id="endDate" placeholder='End Date' value={ed.endDate} onChange={(e) => handleEducationOnChange(e, i)} className='w-full leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-3 border-0 bg-gray-800 rounded' />
                    ...
                    <div className='mt-8 flex justify-center items-center'>
                        <button type='submit' class="w-full md:w-fit font-semibold leading-none flex justify-center items-center text-white py-4 px-10 bg-blue-700 rounded hover:bg-blue-600 focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 focus:outline-none">
                            <p>Save Details</p>
                        </button>
                    </div>
                </div>
