...
import { logoutUserAsync, selectIsLogin } from '../Redux/features/Authentication/AuthenticationSlice';
            ...
            <div className={`${toggleNav ? 'block' : 'hidden'} fixed md:block top-0 left-0 z-30 w-[90vw] sm:w-[300px] min-h-screen bg-gray-900 rounded p-3 shadow-xl`}>
                <div className="flex items-center justify-between p-2 mb-5">
                    <div className='flex items-center justify-center space-x-4'>
                        ...
                        <div>
                            <h4 className="font-semibold text-lg text-white capitalize font-poppins tracking-wide">Tanmay Patil</h4>
                ...
                <ul className="space-y-2 text-sm">
                    ...
                    <li>
                        <Link to="/admin/notifications" className={`group flex items-center space-x-3 ${location.pathname === '/admin/notifications' ? 'text-gray-700' : 'text-white'} hover:text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 ${location.pathname === '/admin/notifications' ? 'bg-gray-200' : ''} focus:bg-gray-200 focus:shadow-outline`}>
                            <span className={`${location.pathname === "/admin/notifications" ? "text-gray-600" : "text-[gold]"} group-hover:text-gray-600`}>
                                <svg className="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                            </span>
                    ...
                    <li>
                        <Link to="/admin/user-messages" className={`group flex items-center space-x-3 ${location.pathname === '/admin/user-messages' ? 'text-gray-700' : 'text-white'} hover:text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 ${location.pathname === '/admin/user-messages' ? 'bg-gray-200' : ''} focus:bg-gray-200 focus:shadow-outline`}>
                            <span className={`${location.pathname === "/admin/user-messages" ? "text-gray-600" : "text-[gold]"} group-hover:text-gray-600`}>
                                <svg className="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li>
                        <Link to="/admin/profile" className={`group flex items-center space-x-3 ${location.pathname === '/admin/profile' ? 'text-gray-700' : 'text-white'} hover:text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 ${location.pathname === '/admin/profile' ? 'bg-gray-200' : ''} focus:bg-gray-200 focus:shadow-outline`}>
                            <span className={`${location.pathname === "/admin/profile" ? "text-gray-600" : "text-[gold]"} group-hover:text-gray-600`}>
                                <svg className="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
